 ...
 * the number of occurrences of 'A' in a text file. In general, since binary
 * files can be compressed, the i-th value written is the number of occurrences
 * of the int i in the data, where 0 <= i < ALPH_SIZE.
 * <P>
 * In this simple scenario, an object would be initialized/constructed from
 * a source of counts, the counts would be written along with a magic number
